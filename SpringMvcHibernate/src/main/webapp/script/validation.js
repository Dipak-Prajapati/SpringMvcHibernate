var xFile, xFirst, xLast, xEmail, xDob, xMobile, xGender, xLanguage, xHobbie, xPassword, xCPassword;

xFile = xFirst = xLast = xEmail = xDob = xMobile = xGender = xLanguage = xHobbie = xPassword = xCPassword = false;
// xAddress=
